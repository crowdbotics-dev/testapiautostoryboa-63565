...
## Project Structure
    ...
    ├── testapiautostoryboa_63565  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_63565`
...
2. Clone this repo and `cd testapiautostoryboa_63565`
